							...
							<ContextMenuTrigger
								render={
									...
									>
										<input
											className={clsx(
												"whitespace-nowrap field-sizing-content min-w-[5ch] font-mono",
												{
													"cursor-pointer outline-none caret-transparent":
														!renameEnabled[tab.id],
													"rounded outline-none ring-2 ring-primary ring-offset-1":
														renameEnabled[tab.id],
												},
											)}
											style={{
												width: `${(tabNames[tab.id] || tab.name).length}ch`,
											}}
											...
											<AlertDialogContent size="sm">
												<AlertDialogHeader>
													...
													<p className="text-muted-foreground text-[.6rem] text-left">
														Tip: hold <Kbd className="text-[.6rem]">Shift</Kbd>{" "}
